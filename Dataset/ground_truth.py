"""Ground truth para evaluación del pipeline.

Recuperado desde Dataset/__pycache__/ground_truth.cpython-313.pyc el 2026-05-23.
Cada entrada describe una etiqueta del Dataset/ con sus ingredientes,
alérgenos declarados y veredictos esperados por restricción.
"""

GROUND_TRUTH = {'foto1': {'nombre': 'Avena arrollada',
           'archivo': 'foto1.jpeg',
           'ingredientes': ['avena arrollada'],
           'alergenos': 'CONTIENE: GLUTEN. CONTIENE AVENA. PUEDE CONTENER: TRIGO, SOJA, CEBADA, CENTENO Y MANÍ.',
           'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': False, 'vegano': True},
           'motivos': {'sin_tacc': 'Contiene avena + alérgenos: GLUTEN', 'sin_frutos_secos': 'Puede contener maní'}},
 'foto2': {'nombre': 'Cereales de maíz (tipo Zucaritas)',
           'archivo': 'foto2.jpeg',
           'ingredientes': ['maíz', 'azúcar', 'sal', 'extracto de malta', 'antioxidante: lecitina de soja'],
           'alergenos': 'CONTIENE SULFITOS Y DERIVADOS DE SOJA Y CEBADA. PUEDE CONTENER AVENA, ALMENDRA Y DERIVADOS DE '
                        'TRIGO Y CENTENO.',
           'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': False, 'vegano': True},
           'motivos': {'sin_tacc': 'Extracto de malta (cebada) + alérgenos',
                       'sin_frutos_secos': 'Puede contener almendra'}},
 'foto3': {'nombre': 'Galletitas (tipo Criollitas)',
           'archivo': 'foto3.jpeg',
           'ingredientes': ['azúcar',
           ...
           'expected': {'sin_tacc': False, 'sin_lactosa': False, 'sin_frutos_secos': False, 'vegano': False},
           'motivos': {'sin_tacc': 'Harina de trigo',
                       'sin_lactosa': 'Puede contener leche',
                       'sin_frutos_secos': 'Puede contener maní',
                       'vegano': 'Puede contener leche y huevo'}},
 'foto4': {'nombre': 'Snack de maíz (tipo Doritos)',
           'archivo': 'foto4.jpeg',
           ...
           'expected': {'sin_tacc': False, 'sin_lactosa': False, 'sin_frutos_secos': False, 'vegano': False},
           'motivos': {'sin_tacc': 'Elaborado en líneas con gluten',
 ...
 'foto5': {'nombre': 'Salsa de tomate (tipo ketchup)',
           'archivo': 'foto5.jpeg',
           'ingredientes': ['agua',
                            ...
                            'sorbato de potasio'],
           'alergenos': '',
           'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto6': {'nombre': 'Harina de trigo vitaminizada',
           'archivo': 'foto6.jpeg',
           ...
           'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False},
           'motivos': {'sin_tacc': 'Harina de trigo', 'vegano': 'Puede contener huevo'}},
 'foto7': {'nombre': 'Almidón de maíz (Maizena)',
           'archivo': 'foto7.jpeg',
           'ingredientes': ['almidón de maíz'],
           'alergenos': 'CONTIENE SULFITOS.',
           'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto8': {'nombre': 'Harina vitaminizada (idéntica a foto 6)',
           'archivo': 'foto8.jpeg',
           'ingredientes': ['harina de trigo enriquecida',
                            'fumarato ferroso',
                            'óxido de zinc',
           ...
           'alergenos': 'CONTIENE DERIVADOS DE TRIGO. PUEDE CONTENER HUEVO Y SOJA.',
           'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto9': {'nombre': 'Harina de trigo 000',
           'archivo': 'foto9.jpeg',
           'ingredientes': ['harina de trigo enriquecida'],
           'alergenos': 'CONTIENE DERIVADOS DE TRIGO. PUEDE CONTENER HUEVO Y SOJA.',
           'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto10': {'nombre': 'Mayonesa/aderezo',
            'archivo': 'foto10.jpeg',
            'ingredientes': ['agua',
                             'aceite de girasol',
                             'azúcar',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False},
            'motivos': {'vegano': 'Contiene huevo'}},
 'foto11': {'nombre': 'Ketchup',
            'archivo': 'foto11.jpeg',
            'ingredientes': ['agua',
                             'concentrado doble de tomate',
                             'azúcar',
 ...
 'foto12': {'nombre': 'Mostaza',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True},
            'motivos': {'sin_tacc': 'Puede contener trigo, avena, cebada, centeno'}},
 'foto13': {'nombre': 'Harina 0000',
            'archivo': 'foto13.jpeg',
            'ingredientes': ['harina 0000 enriquecida',
                             'harina de trigo',
                             'sulfato ferroso',
                             'nicotinamida',
                             'tiamina',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto14': {'nombre': 'Chocolatada en polvo (Nesquik)',
            'archivo': 'foto14.jpeg',
            'ingredientes': ['azúcar',
                             'cacao en polvo',
                             'suero de leche',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': False, 'sin_frutos_secos': True, 'vegano': False}},
 'foto15': {'nombre': 'Sal (Celusal)',
            'archivo': 'foto15.jpeg',
            'ingredientes': ['sal', 'cloruro de sodio', 'yodato de potasio', 'INS 551', 'INS 536'],
            'alergenos': 'Libre de gluten - Sin T.A.C.C.',
            'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto16': {'nombre': 'Tapas de empanadas',
            'archivo': 'foto16.jpeg',
            'ingredientes': ['harina de trigo 000 enriquecida',
                             ...
                             'INS 330',
                             'INS 920'],
            'alergenos': 'CONTIENE DERIVADOS DE TRIGO. PUEDE CONTENER HUEVO, LECHE, DERIVADOS DE SOJA, DE AVENA Y DE '
                         'CEBADA.',
            'expected': {'sin_tacc': False, 'sin_lactosa': False, 'sin_frutos_secos': True, 'vegano': False}},
 'foto17': {'nombre': 'Caldo en cubo (Knorr)',
            'archivo': 'foto17.jpeg',
            'ingredientes': ['sal',
                             'grasa vegetal',
                             'almidón de maíz',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto18': {'nombre': 'Sopa instantánea (Knorr)',
            'archivo': 'foto18.jpeg',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': False, 'sin_frutos_secos': True, 'vegano': False}},
 'foto19': {'nombre': 'Tomate pelado enlatado',
            'archivo': 'foto19.jpeg',
            'ingredientes': ['tomate pelado', 'jugo de tomates', 'ácido cítrico'],
            'alergenos': '',
            'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto20': {'nombre': 'Puré de tomate',
            'archivo': 'foto20.jpeg',
            'ingredientes': ['tomate', 'ácido cítrico'],
            'alergenos': '',
            'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto21': {'nombre': 'Atún en lata',
            'archivo': 'foto21.jpeg',
            'ingredientes': ['atún', 'agua', 'sal'],
            'alergenos': 'CONTIENE PESCADO.',
            'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto22': {'nombre': 'Fideos al huevo',
            'archivo': 'foto22.jpeg',
            'ingredientes': ['harina de trigo tipo 000 enriquecida', 'huevo'],
            'alergenos': 'CONTIENE HUEVO Y DERIVADOS DE TRIGO. PUEDE CONTENER SOJA.',
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto23': {'nombre': 'Harina de trigo',
            'archivo': 'foto23.jpeg',
            'ingredientes': ['harina de trigo enriquecida'],
            'alergenos': 'CONTIENE DERIVADOS DE TRIGO. PUEDE CONTENER HUEVO Y SOJA.',
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto24': {'nombre': 'Fideos de sémola',
            'archivo': 'foto24.jpeg',
            'ingredientes': ['harina de trigo enriquecida', 'sémola de trigo candeal', 'agua'],
            'alergenos': 'CONTIENE DERIVADOS DE TRIGO.',
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto25': {'nombre': 'Imagen borrosa (no legible)',
            'archivo': 'foto25.jpeg',
            'mala_calidad': True,
            'expected_error': True},
 'foto26': {'nombre': 'Imagen borrosa (no legible)',
            'archivo': 'foto26.jpeg',
            'mala_calidad': True,
            'expected_error': True},
 'foto27': {'nombre': 'Galletitas de chocolate (tipo Pepitos)',
            'archivo': 'foto27.jpeg',
            'ingredientes': ['harina de trigo enriquecida',
                             'azúcar',
                             'grasa bovina refinada',
 ...
 'foto28': {'nombre': 'Jugo de naranja',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto29': {'nombre': 'Postre lácteo de chocolate',
            'archivo': 'foto29.jpeg',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': False, 'sin_frutos_secos': True, 'vegano': False}},
 'foto30': {'nombre': 'Snack de maíz sabor queso',
            'archivo': 'foto30.jpeg',
            'ingredientes': ['harina de maíz',
                             'aceite de girasol',
                             'sal',
 ...
 'foto31': {'nombre': 'Pan lactal',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto32': {'nombre': 'Mermelada de frutilla light',
            'archivo': 'foto32.jpeg',
 ...
 'foto33': {'nombre': 'Salchicha',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto34': {'nombre': 'Pan de queso / chipá',
            'archivo': 'foto34.jpeg',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': False, 'sin_frutos_secos': True, 'vegano': False}},
 'foto35': {'nombre': 'Galletitas de agua (tipo Traviata)',
            'archivo': 'foto35.jpeg',
            'ingredientes': ['harina de trigo enriquecida',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto36': {'nombre': 'Jugo en polvo sabor manzana',
            'archivo': 'foto36.jpeg',
            'ingredientes': ['azúcar',
                             'maltodextrina',
                             'jugo de manzana deshidratado',
                             'ácido cítrico',
                             'aspartamo',
                             'acesulfame K',
                             'fosfato tricálcico',
 ...
 'foto37': {'nombre': 'Mayonesa',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': False}},
 'foto38': {'nombre': 'Yogur de durazno',
            'archivo': 'foto38.jpeg',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': False, 'sin_frutos_secos': True, 'vegano': False}},
 'foto39': {'nombre': 'Pan dulce',
            'archivo': 'foto39.jpeg',
            'ingredientes': ['harina de trigo 0000 enriquecida',
                             'azúcar',
                             'agua',
                             'aceite de palma',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': False, 'vegano': False}},
 'foto40': {'nombre': 'Salsa de soja',
            'archivo': 'foto40.jpeg',
            'ingredientes': ['agua',
                             'poroto de soja',
                             'trigo',
 ...
 'foto41': {'nombre': 'Gomitas',
            ...
            'expected': {'sin_tacc': True, 'sin_lactosa': False, 'sin_frutos_secos': True, 'vegano': False}},
 'foto42': {'nombre': 'Cereales (tipo Corn Flakes)',
            'archivo': 'foto42.jpeg',
            'ingredientes': ['harina de maíz',
                             'azúcar',
                             'extracto de malta',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': True, 'sin_frutos_secos': True, 'vegano': True}},
 'foto43': {'nombre': 'Alfajor de chocolate',
            'archivo': 'foto43.jpeg',
            ...
            'expected': {'sin_tacc': False, 'sin_lactosa': False, 'sin_frutos_secos': False, 'vegano': False}},
 'foto44': {'nombre': 'Sopa de pollo con fideos',
            'archivo': 'foto44.jpeg',
            'ingredientes': ['fideos',
                             'harina de trigo enriquecida',
                             'agua',
